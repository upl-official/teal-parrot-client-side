      ...
      <div className="flex-grow container mx-auto px-4 py-16">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Welcome to Teal Parrot. These Terms of Use constitute a legally binding agreement between you and Teal
              Parrot governing your access to and use of the website, including any content, functionality, and services
              offered on or through the website.
            </p>
            <p className="mb-4">
              By accessing or using our website, you confirm that you accept these Terms of Use and agree to comply with
              them. If you do not agree to these terms, you must not access or use our website.
            </p>
            <p>We recommend that you print a copy of these terms for future reference.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Changes to the Terms</h2>
            <p>
              We may revise and update these Terms of Use from time to time at our sole discretion. All changes are
              effective immediately when we post them. Your continued use of the website following the posting of
              revised Terms of Use means that you accept and agree to the changes. You are expected to check this page
              frequently so you are aware of any changes, as they are binding on you.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Accessing the Website</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">User Accounts</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Intellectual Property Rights</h2>
            <p className="mb-4">
              The website and its entire contents, features, and functionality (including but not limited to all
              information, software, text, displays, images, video, and audio, and the design, selection, and
              arrangement thereof) are owned by Teal Parrot, its licensors, or other providers of such material and are
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Access or use for any commercial purposes any part of the website or any services or materials available
                through the website
              </li>
            </ul>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Prohibited Uses</h2>
            <p className="mb-4">
              You may use the website only for lawful purposes and in accordance with these Terms of Use. You agree not
              to use the website:
            </p>
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                which may harm the Company or users of the website or expose them to liability
              </li>
            </ul>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Product Information and Pricing</h2>
            <p className="mb-4">
              We strive to provide accurate product descriptions and pricing information. However, we do not warrant
              that product descriptions, pricing, or other content on the website is accurate, complete, reliable,
              current, or error-free. If a product offered by us is not as described, your sole remedy is to return it
              in unused condition.
            </p>
            <p className="mb-4">
              All prices are shown in USD and are exclusive of taxes unless otherwise stated. We reserve the right to
              change prices for products displayed at any time, and to correct pricing errors that may inadvertently
              occur.
            </p>
            <p>
              The inclusion of any products or services on the website does not imply or warrant that these products or
              services will be available at any time.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Purchases and Payment</h2>
            <p className="mb-4">
              All purchases through our website are subject to our order acceptance. We may, in our sole discretion,
              refuse to accept an order, limit quantities purchased per person or per order, or cancel any order.
            </p>
            <p className="mb-4">
              Payment must be received prior to acceptance of an order. We accept various payment methods as indicated
              on the website. By providing a payment method, you represent and warrant that you are authorized to use
              the designated payment method and that you authorize us to charge your payment method for the total amount
              of your order (including any taxes and shipping charges).
            </p>
            <p>
              If the payment method you provide cannot be verified, is invalid, or is otherwise not acceptable, your
              order may be suspended or cancelled. You must resolve any payment issues before we will proceed with your
              order.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Shipping and Delivery</h2>
            <p className="mb-4">
            ...
            <p>
              You are responsible for providing accurate shipping information. We are not responsible for any delays or
              issues arising from inaccurate or incomplete shipping information.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Returns and Refunds</h2>
            <p className="mb-4">
              Our return and refund policy is outlined separately on our website. By making a purchase, you agree to be
              bound by our return and refund policy in effect at the time of purchase.
            </p>
            <p>We reserve the right to modify our return and refund policy at any time, with or without notice.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Disclaimer of Warranties</h2>
            <p className="mb-4">
              THE WEBSITE AND ALL INFORMATION, CONTENT, MATERIALS, PRODUCTS (INCLUDING SOFTWARE), AND SERVICES INCLUDED
              ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE WEBSITE ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE"
              BASIS, UNLESS OTHERWISE SPECIFIED IN WRITING.
            </p>
            <p className="mb-4">
              WE MAKE NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THE
              WEBSITE OR THE INFORMATION, CONTENT, MATERIALS, PRODUCTS (INCLUDING SOFTWARE), OR SERVICES INCLUDED ON OR
              OTHERWISE MADE AVAILABLE TO YOU THROUGH THE WEBSITE, UNLESS OTHERWISE SPECIFIED IN WRITING.
            </p>
            <p className="mb-4">
              TO THE FULL EXTENT PERMISSIBLE BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT
              LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.
            </p>
            <p>
              WE DO NOT WARRANT THAT THE WEBSITE, ITS CONTENT, OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Indemnification</h2>
            <p>
              You agree to defend, indemnify, and hold harmless Teal Parrot, its affiliates, licensors, and service
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Governing Law and Jurisdiction</h2>
            <p className="mb-4">
              All matters relating to the website and these Terms of Use, and any dispute or claim arising therefrom or
              related thereto, shall be governed by and construed in accordance with the internal laws of India without
              giving effect to any choice or conflict of law provision or rule.
            </p>
            <p>
              Any legal suit, action, or proceeding arising out of, or related to, these Terms of Use or the website
              shall be instituted exclusively in the courts located in New Delhi, India. You waive any and all
              objections to the exercise of jurisdiction over you by such courts and to venue in such courts.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Waiver and Severability</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Entire Agreement</h2>
            <p>
              The Terms of Use, our Privacy Policy, and any terms and conditions incorporated herein by reference
              constitute the sole and entire agreement between you and Teal Parrot regarding the website and supersede
              all prior and contemporaneous understandings, agreements, representations, and warranties, both written
              and oral, regarding the website.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-teal-500 mb-4">Contact Information</h2>
