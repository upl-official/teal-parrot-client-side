        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Discover exquisite silver jewelry crafted with passion and precision.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/return-exchange-policy" className="text-gray-400 hover:text-white transition-colors">
                  Return & Exchange
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Teal Parrot. All rights reserved.
            </div>
            <div className="mt-4 md:mt-0">
              <p className="text-gray-400 text-sm">
                Made with ❤️ by{" "}
                <Link href="https://brandsthink.in" className="text-teal-400 hover:text-teal-300 transition-colors">
                  Brandsthink
                </Link>
              </p>
            </div>
